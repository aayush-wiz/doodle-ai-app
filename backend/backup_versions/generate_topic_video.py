...
from create_doodle_video import DoodleVideoGeneratorV7_4 as DoodleVideoGenerator
...
def main():
    ...
    parser.add_argument("--output_dir", default="topic_videos", help="Output dir")
